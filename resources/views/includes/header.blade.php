<nav class=" bg-gray-200 p-4">
   <div class="container mx-auto flex justify-between items-center">
      ...
      <a class="text-xl font-semibold" href="{{ route('home') }}">FaithWear</a>
      ...
      <div class="hidden lg:flex items-center space-x-4 w-full justify-between" id="menu">
         ...
         <li>
            <a class="text-red-500 font-medium" href="{{route('home')}}">Home</a>
         </li>
         <li>
         ...
         @auth
         <li>
            <a class="text-gray-600 hover:text-gray-900" href="{{ url('/') }}">Logout</a>
         </li>
         @endauth
         </ul>
      </div>
